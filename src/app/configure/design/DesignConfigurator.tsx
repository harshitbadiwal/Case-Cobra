...
import HandleComponent from "@/components/HandleComponet";
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-1 items-center p-1.5 curser-default hover:bg-zinc-100",
                            {
                              "bg-zinc-100":
                  ...
                  ({ name, options: selectableOptons }) => (
                    ...
                    >
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptons.map((option) => (
                          <RadioGroup.Option
                            key={option.value}
                            value={option}
                            className={({ active, checked }) =>
                              cn(
                                "realtive block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 focus:outline-none sm:flex sm:justify-between",
                                {
        ...
        <div className="w-full px-8 h-16 bg-white ">
          <div className="h-px h-full bg-zinc-200 " />
