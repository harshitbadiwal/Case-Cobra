...
const DesignPreview = ({configuration}:{configuration: Configuration}) => {
  ...
  const {mutate:createPaymentSession} = useMutation({
    mutationKey: ["get-checkout-seesion"],
            ...
            <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 md:py-10">
              ...
              <div>
                ...
                <ol className="mt-3 text-zinc-700 list-disc list-inside">
                  ...
                  <li>Scratch and fingurprint resistant coating</li>
                </ol>
              </div>
            </div>
            <div className="mt-8">
              <div className="bg-gray-50 p-6 sm:rounded-lg sn:p-8">
